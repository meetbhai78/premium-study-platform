...
export default function Home() {
  ...
  const categories = [
    ...
    { name: 'Std 9 English', icon: Languages, color: 'from-pink-400 to-rose-500', desc: 'ધોરણ ૯ અંગ્રેજી પ્રકરણ-વાર વ્યાકરણ' },
    ...
    { name: 'Std 10 English', icon: Languages, color: 'from-violet-400 to-pink-500', desc: 'ધોરણ ૧૦ અંગ્રેજી બોર્ડ આઈએમપી સોલ્યુશન્સ' },
    ...
    { name: 'Std 6 to 8 SS', icon: Globe, color: 'from-emerald-400 to-cyan-600', desc: 'ધોરણ ૬ થી ૮ સામાજિક વિજ્ઞાન પુસ્તકો' },
