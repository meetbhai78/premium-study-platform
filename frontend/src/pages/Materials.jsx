...
export default function Materials() {
  ...
  const categoryConfigs = {
    ...
    'Std 6': { icon: GraduationCap, color: 'from-emerald-500 to-teal-600' },
    'Std 7': { icon: GraduationCap, color: 'from-teal-500 to-cyan-600' },
    'Std 8': { icon: GraduationCap, color: 'from-cyan-500 to-sky-600' },
