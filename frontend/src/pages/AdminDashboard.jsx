...
export default function AdminDashboard() {
  ...
  const chartData = [
    ...
    { label: 'Std 9 Eng', pct: '9%', height: 38, fill: 'url(#indigoBar)' },
    ...
    { label: 'Std 10 Eng', pct: '10%', height: 42, fill: 'url(#purpleBar)' },
    ...
    { label: 'Std 6-8 SS', pct: '8%', height: 35, fill: 'url(#cyanBar)' },
